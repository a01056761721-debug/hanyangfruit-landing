 ...
 *   상품보기/주문방법/배송지역은 이모지↔글 gap-3(12px), 나머지는 gap-1(4px).
 */
  ...
  return (
    ...
    >
      {items.map((item) => {
        ...
        const smGapClass =
          itemGap === MAIN_NAV_ICON_LABEL_GAP ? "sm:gap-3" : "sm:gap-1";
        return (
          <Link
            key={item.id}
            href={item.href}
